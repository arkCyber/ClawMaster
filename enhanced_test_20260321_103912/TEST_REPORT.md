...
**测试时间**: Sat Mar 21 10:40:01 CST 2026  
**测试模式**: 直接测试（非 WASM 容器）  
**测试范围**: 扩展场景测试
...
PASS: exec - 统计文件数量 (0s)
PASS: exec - 创建临时文件 (0s)
PASS: exec - 文本处理 - awk (0s)
PASS: exec - 条件判断 (0s)
PASS: exec - 循环处理 (0s)
PASS: web_fetch - 测试延迟响应 (0s)
PASS: sessions - 列出所有会话 (0s)
PASS: sessions - 显示会话统计 (0s)
PASS: config - 验证配置文件 (0s)
PASS: sandbox - 列出沙箱包 (0s)
PASS: 综合 - 文件统计分析 (0s)
PASS: 综合 - 多步骤处理 (0s)
PASS: 综合 - 条件过滤 (0s)
PASS: 综合 - 排序操作 (0s)
...
**生成时间**: Sat Mar 21 10:40:01 CST 2026
