...
pub enum AuthEvent {
    ...
    /// Password change
    PasswordChange { username: String, success: bool },
...
pub enum SystemEvent {
    ...
    /// Database migration
    DatabaseMigration { version: String, success: bool },
...
impl AuditEvent {
    ...
    pub fn config_change(severity: EventSeverity, event: ConfigChangeEvent) -> Self {
        Self::new(
            ...
            EventDetails::ConfigChange(event),
        )
    }
...
mod tests {
    ...
    fn test_security_event_creation() {
        let event =
            AuditEvent::security(EventSeverity::Critical, SecurityEvent::RateLimitExceeded {
    ...
    fn test_event_serialization() {
        let event = AuditEvent::system(EventSeverity::Info, SystemEvent::ServiceStarted {
    ...
    fn test_event_with_metadata() {
        let event = AuditEvent::auth(EventSeverity::Medium, AuthEvent::Logout {
            username: "user1".to_string(),
