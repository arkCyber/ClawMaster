...
use {
    bytes::Bytes,
    clawmaster_voice::{
        AudioQuality, EnergyVad, VadConfig, apply_fade_in, apply_fade_out, bytes_to_samples,
        calculate_duration, mono_to_stereo, normalize_volume, resample, stereo_to_mono,
        trim_silence,
