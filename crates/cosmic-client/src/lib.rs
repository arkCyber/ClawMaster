...
impl CosmicClient {
    ...
    pub async fn get_sessions(&self) -> Result<Vec<Session>> {
        ...
        let sessions: Vec<Session> = self.rpc_client.call("sessions.list", ()).await
    ...
    pub async fn create_session(&self, title: Option<String>) -> Result<Session> {
        ...
        let session: Session = self.rpc_client.call("sessions.create", (title,)).await
    ...
    pub async fn send_message(&self, session_id: &str, message: &str) -> Result<Message> {
        ...
        let msg: Message = self.rpc_client.call("chat.send", (session_id, message)).await
    ...
    pub async fn get_messages(&self, session_id: &str, limit: Option<u32>) -> Result<Vec<Message>> {
        debug!("Fetching messages for session {} with limit {:?}", session_id, limit);
        let messages: Vec<Message> = self.rpc_client.call("chat.messages", (session_id, limit)).await
    ...
    pub async fn get_system_status(&self) -> Result<SystemStatus> {
        ...
        let status: SystemStatus = self.rpc_client.call("system.status", ()).await
    ...
    pub async fn get_models(&self) -> Result<Vec<Model>> {
        ...
        let models: Vec<Model> = self.rpc_client.call("models.list", ()).await
    ...
    pub async fn get_config(&self) -> Result<Config> {
        ...
        let config: Config = self.rpc_client.call("config.get", ()).await
    ...
    pub async fn update_config(&mut self, config: CosmicConfig) -> Result<()> {
        ...
        self.rpc_client.call::<()>("config.update", (config,)).await
    ...
    pub async fn get_recent_activity(&self, limit: Option<u32>) -> Result<Vec<Activity>> {
        ...
        let activity: Vec<Activity> = self.rpc_client.call("activity.recent", (limit,)).await
