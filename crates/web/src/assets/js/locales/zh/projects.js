...
export default {
	...
	clearAllHint: "清除全部仅从 ClawMaster 中移除仓库条目，不会删除磁盘上的任何内容。",
	noProjectsConfigured: "未配置项目。在上方添加目录或使用自动检测。",
	confirmClearAll: "从 ClawMaster 清除所有仓库？这仅从列表中移除，不会删除磁盘上的文件。",
	...
	clearAllTooltip: "从 ClawMaster 移除所有仓库条目，不删除磁盘上的文件",
	pathInput: {
		directory: "目录",
	...
	editForm: {
		...
		branchPrefix: "分支前缀",
		branchPrefixPlaceholder: "默认：clawmaster",
		sandboxImage: "沙盒镜像",
