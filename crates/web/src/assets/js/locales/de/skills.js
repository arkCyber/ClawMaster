...
export default {
	...
	securitySandbox:
		"Mit aktiviertem Sandbox-Modus (Docker, Apple Container oder cgroup) ist die Befehlsausführung isoliert und der Schaden, den eine bösartige Fähigkeit anrichten kann, ist erheblich begrenzt.",
	dismiss: "Ablehnen",
	disableAllThirdParty: "Alle Drittanbieter-Fähigkeiten deaktivieren",

	// ── Featured skill descriptions ─────────────────────────
	featuredOpenClaw: "Community-Fähigkeiten von ClawdHub",
	featuredAnthropic: "Offizielle Anthropic-Agent-Fähigkeiten",
	featuredVercelAgent: "Vercel-Agent-Fähigkeiten-Sammlung",
	featuredVercelSkills: "Vercel-Fähigkeiten-Toolkit",
	confirmDisableAll: "Alle Drittanbieter-Fähigkeiten jetzt deaktivieren?",
	confirmInstall: "Abhängigkeit für {{name}} installieren?\n\n{{preview}}\n\nFortfahren Sie nur, wenn Sie dieser Fähigkeit und ihrer Quelle vertrauen.",
	confirmTrust: "Fähigkeit \"{{name}}\" von {{source}} vertrauen?",
	confirmDelete: "Fähigkeit \"{{name}}\" löschen? Dies entfernt die SKILL.md-Datei.",
};
