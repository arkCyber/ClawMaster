...
export default {
	...
	featuredOpenClaw: "ClawdHub의 커뮤니티 스킬",
	featuredAnthropic: "공식 Anthropic 에이전트 스킬",
	featuredVercelAgent: "Vercel 에이전트 스킬 모음",
	featuredVercelSkills: "Vercel 스킬 툴킷",
	confirmDisableAll: "모든 타사 스킬을 지금 비활성화하시겠습니까?",
	confirmInstall: "{{name}}에 대한 종속성을 설치하시겠습니까?\n\n{{preview}}\n\n이 스킬과 출처를 신뢰하는 경우에만 계속하십시오.",
	confirmTrust: "{{source}}의 스킬 \"{{name}}\"을(를) 신뢰하시겠습니까?",
	confirmDelete: "스킬 \"{{name}}\"을(를) 삭제하시겠습니까? SKILL.md 파일이 제거됩니다.",
};
