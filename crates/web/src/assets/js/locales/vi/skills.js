...
export default {
	...
	dismiss: "Bỏ qua",
	disableAllThirdParty: "Vô hiệu hóa tất cả kỹ năng bên thứ ba",

	// ── Featured skill descriptions ─────────────────────────
	featuredOpenClaw: "Kỹ năng cộng đồng từ ClawdHub",
	featuredAnthropic: "Kỹ năng đại diện chính thức của Anthropic",
	featuredVercelAgent: "Bộ sưu tập kỹ năng đại diện Vercel",
	featuredVercelSkills: "Bộ công cụ kỹ năng Vercel",
	confirmDisableAll: "Vô hiệu hóa tất cả kỹ năng bên thứ ba ngay bây giờ?",
	confirmInstall: "Cài đặt phụ thuộc cho {{name}}?\n\n{{preview}}\n\nChỉ tiếp tục nếu bạn tin tưởng kỹ năng này và nguồn của nó.",
	confirmTrust: "Tin tưởng kỹ năng \"{{name}}\" từ {{source}}?",
	confirmDelete: "Xóa kỹ năng \"{{name}}\"? Thao tác này xóa tệp SKILL.md.",
};
