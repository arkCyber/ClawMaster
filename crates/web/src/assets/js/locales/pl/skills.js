...
export default {
	...
	securitySandbox:
		"Z włączonym trybem piaskownicy (Docker, Apple Container lub cgroup) wykonanie poleceń jest izolowane, a szkody, jakie może wyrządzić zła umiejętność, są znacznie ograniczone.",
	dismiss: "Odrzuć",
	disableAllThirdParty: "Wyłącz wszystkie umiejętności stron trzecich",
	...
	featuredVercelSkills: "Zestaw narzędzi umiejętności Vercel",
	confirmDisableAll: "Wyłączyć teraz wszystkie umiejętności stron trzecich?",
	confirmInstall: "Zainstalować zależność dla {{name}}?\n\n{{preview}}\n\nKontynuuj tylko jeśli ufasz tej umiejętności i jej źródłu.",
	confirmTrust: "Zaufać umiejętności \"{{name}}\" ze źródła {{source}}?",
	confirmDelete: "Usunąć umiejętność \"{{name}}\"? Spowoduje to usunięcie pliku SKILL.md.",
};
