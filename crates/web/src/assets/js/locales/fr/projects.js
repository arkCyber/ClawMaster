...
export default {
	...
	clearAllHint: "Clear All only removes repository entries from ClawMaster, it does not delete anything from disk.",
	noProjectsConfigured: "No projects configured. Add a directory above or use auto-detect.",
	confirmClearAll:
		"Clear all repositories from ClawMaster? This only removes them from the list and does not delete files on disk.",
	...
	clearAllTooltip: "Remove all repository entries from ClawMaster without deleting files on disk",
	pathInput: {
		directory: "Directory",
	...
	editForm: {
		...
		branchPrefixPlaceholder: "default: clawmaster",
