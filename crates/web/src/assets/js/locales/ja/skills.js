...
export default {
	...
	featuredOpenClaw: "ClawdHubからのコミュニティスキル",
	featuredAnthropic: "公式Anthropicエージェントスキル",
	featuredVercelAgent: "Vercelエージェントスキルコレクション",
	featuredVercelSkills: "Vercelスキルツールキット",
	confirmDisableAll: "すべてのサードパーティスキルを今すぐ無効にしますか？",
	confirmInstall: "{{name}}の依存関係をインストールしますか？\n\n{{preview}}\n\nこのスキルとそのソースを信頼する場合のみ続行してください。",
	confirmTrust: "{{source}}からのスキル\"{{name}}\"を信頼しますか？",
	confirmDelete: "スキル\"{{name}}\"を削除しますか？これによりSKILL.mdファイルが削除されます。",
}; 
