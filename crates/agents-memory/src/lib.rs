...
mod tests {
    ...
    async fn test_search() {
        ...
        memory.append_raw("Important note about Rust performance").await.unwrap();
    ...
    async fn test_multiple_entries() {
        ...
        memory.append_entry(MemoryEntry::learning_record("Learned about async/await"))
            .await
            .unwrap();
        
        memory.append_entry(MemoryEntry::important_decision("Decided to use Tokio"))
            .await
            .unwrap();
