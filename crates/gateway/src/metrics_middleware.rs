...
#[cfg(feature = "metrics")]
use clawmaster_metrics::{http as http_metrics, labels};

/// Middleware that collects HTTP request metrics.
///
/// This records:
/// - `clawmaster_http_requests_total`: Counter of total requests by endpoint, method, and status
/// - `clawmaster_http_request_duration_seconds`: Histogram of request durations
/// - `clawmaster_http_requests_in_flight`: Gauge of currently processing requests
#[cfg(feature = "metrics")]
