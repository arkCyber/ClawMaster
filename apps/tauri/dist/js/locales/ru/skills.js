...
export default {
	...
	featuredOpenClaw: "Навыки сообщества от ClawdHub",
	featuredAnthropic: "Официальные навыки агента Anthropic",
	featuredVercelAgent: "Коллекция навыков агента Vercel",
	featuredVercelSkills: "Набор навыков Vercel",
	confirmDisableAll: "Отключить все сторонние навыки сейчас?",
	confirmInstall: "Установить зависимость для {{name}}?\n\n{{preview}}\n\nПродолжайте только если вы доверяете этому навыку и его источнику.",
	confirmTrust: "Доверять навыку \"{{name}}\" от {{source}}?",
	confirmDelete: "Удалить навык \"{{name}}\"? Это удалит файл SKILL.md.",
}; 
