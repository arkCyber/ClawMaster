...
export default {
	...
	securitySandbox:
		"Met sandboxmodus ingeschakeld (Docker, Apple Container of cgroup) is opdrachtuitvoering geïsoleerd en is de schade die een kwaadaardige vaardigheid kan aanrichten aanzienlijk beperkt.",
	dismiss: "Annuleren",
	disableAllThirdParty: "Alle vaardigheden van derden uitschakelen",

	// ── Featured skill descriptions ─────────────────────────
	featuredOpenClaw: "Communityvaardigheden van ClawdHub",
	featuredAnthropic: "Officiële Anthropic-agentvaardigheden",
	featuredVercelAgent: "Vercel-agentvaardigheden collectie",
	featuredVercelSkills: "Vercel-vaardighedentoolkit",
	confirmDisableAll: "Alle vaardigheden van derden nu uitschakelen?",
	confirmInstall: "Afhankelijkheid voor {{name}} installeren?\n\n{{preview}}\n\nGa alleen verder als u deze vaardigheid en de bron ervan vertrouwt.",
	confirmTrust: "Vaardigheid \"{{name}}\" van {{source}} vertrouwen?",
	confirmDelete: "Vaardigheid \"{{name}}\" verwijderen? Dit verwijdert het SKILL.md-bestand.",
};
