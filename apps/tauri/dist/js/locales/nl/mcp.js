...
export default {
	...
	introDetail:
		"Each tool runs as a <strong>local process</strong> on your machine (spawned via npm/uvx). ClawMaster connects to it over stdio and the process makes outbound API calls on your behalf using your tokens. No data is sent to third-party MCP hosts.",
	...
	popularTitle: "Populaire MCP-servers",
	browseAll: "Bladeren door alle servers op GitHub \u2192",
	...
	remove: "Verwijderen",
	confirmRemove: "Dit stopt en verwijdert de MCP-tool \"{{name}}\". Deze actie kan niet ongedaan worden gemaakt.",

	// ── Featured server descriptions ────────────────────────
	featured: {
		filesystemDesc: "Beveiligde bestandsbewerkingen met configureerbare toegangscontrole",
		filesystemHint: "Laatste argument is het toegestane directory-pad",
		memoryDesc: "Knowledge graph-based persistent memory system",
		githubDesc: "GitHub API-integratie \u2014 repos, issues, PRs, code search",
