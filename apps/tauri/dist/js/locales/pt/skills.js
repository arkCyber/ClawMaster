...
export default {
	...
	securitySandbox:
		"Com o modo sandbox habilitado (Docker, Apple Container ou cgroup), a execução de comandos é isolada e o dano que uma habilidade maliciosa pode causar é significativamente limitado.",
	dismiss: "Descartar",
	disableAllThirdParty: "Desativar todas as habilidades de terceiros",

	// ── Featured skill descriptions ─────────────────────────
	featuredOpenClaw: "Habilidades da comunidade do ClawdHub",
	featuredAnthropic: "Habilidades oficiais de agente Anthropic",
	featuredVercelAgent: "Coleção de habilidades de agente Vercel",
	featuredVercelSkills: "Kit de ferramentas de habilidades Vercel",
	confirmDisableAll: "Desativar todas as habilidades de terceiros agora?",
	confirmInstall: "Instalar dependência para {{name}}?\n\n{{preview}}\n\nContinue apenas se confiar nesta habilidade e em sua fonte.",
	confirmTrust: "Confiar na habilidade \"{{name}}\" de {{source}}?",
	confirmDelete: "Excluir habilidade \"{{name}}\"? Isso remove o arquivo SKILL.md.",
};
