...
export default {
	...
	confirmDisableAll: "¿Desactivar todas las habilidades de terceros ahora?",
	confirmInstall: "¿Instalar dependencia para {{name}}?\n\n{{preview}}\n\nSolo continúe si confía en esta habilidad y su fuente.",
	confirmTrust: "¿Confiar en la habilidad \"{{name}}\" de {{source}}?",
	confirmDelete: "¿Eliminar habilidad \"{{name}}\"? Esto elimina el archivo SKILL.md.",
};
