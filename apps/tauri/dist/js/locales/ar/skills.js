...
export default {
	...
	featuredOpenClaw: "مهارات المجتمع من ClawdHub",
	featuredAnthropic: "مهارات الوكيل الرسمية من Anthropic",
	featuredVercelAgent: "مجموعة مهارات وكيل Vercel",
	featuredVercelSkills: "مجموعة أدوات مهارات Vercel",
	confirmDisableAll: "تعطيل جميع المهارات من جهات خارجية الآن؟",
	confirmInstall: "تثبيت التبعية لـ {{name}}؟\n\n{{preview}}\n\nتابع فقط إذا كنت تثق في هذه المهارة ومصدرها.",
	confirmTrust: "الوثوق بالمهارة \"{{name}}\" من {{source}}؟",
	confirmDelete: "حذف المهارة \"{{name}}\"؟ سيؤدي هذا إلى إزالة ملف SKILL.md.",
};
