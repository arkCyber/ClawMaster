...
export default {
	...
	securitySandbox:
		"Con la modalità sandbox abilitata (Docker, Apple Container o cgroup), l'esecuzione dei comandi è isolata e il danno che un'abilità maliziosa può fare è significativamente limitato.",
	dismiss: "Ignora",
	disableAllThirdParty: "Disattiva tutte le abilità di terze parti",

	// ── Featured skill descriptions ─────────────────────────
	featuredOpenClaw: "Abilità della comunità da ClawdHub",
	featuredAnthropic: "Abilità ufficiali dell'agente Anthropic",
	featuredVercelAgent: "Raccolta di abilità dell'agente Vercel",
	featuredVercelSkills: "Toolkit di abilità Vercel",
	confirmDisableAll: "Disattivare tutte le abilità di terze parti ora?",
	confirmInstall: "Installare la dipendenza per {{name}}?\n\n{{preview}}\n\nContinua solo se ti fidi di questa abilità e della sua fonte.",
	confirmTrust: "Fidarsi dell'abilità \"{{name}}\" da {{source}}?",
	confirmDelete: "Eliminare l'abilità \"{{name}}\"? Questo rimuove il file SKILL.md.",
};
