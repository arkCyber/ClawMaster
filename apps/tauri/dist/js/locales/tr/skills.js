...
export default {
	...
	securitySandbox:
		"Kumanda modu etkinleştirildiğinde (Docker, Apple Container veya cgroup), komut çalıştırması izole edilir ve kötü niyetli bir becerinin yapabileceği zarar önemli ölçüde sınırlanır.",
	dismiss: "Vazgeç",
	disableAllThirdParty: "Tüm üçüncü taraf becerilerini devre dışı bırak",
	confirmDisableAll: "Şimdi tüm üçüncü taraf becerilerini devre dışı bırakılsın mı?",
	confirmInstall: "{{name}} için bağımlılık yüklensin mi?\n\n{{preview}}\n\nYalnızca bu beceriye ve kaynağına güveniyorsanız devam edin.",
	confirmTrust: "{{source}} kaynağındaki \"{{name}}\" becerisine güvenilsin mi?",
	confirmDelete: "\"{{name}}\" becerisi silinsin mi? Bu, SKILL.md dosyasını kaldırır.",
	featuredOpenClaw: "ClawdHub'dan topluluk becerileri",
	featuredAnthropic: "Resmi Anthropic ajan becerileri",
	featuredVercelAgent: "Vercel ajan becerileri koleksiyonu",
	featuredVercelSkills: "Vercel beceri araç seti",
};
