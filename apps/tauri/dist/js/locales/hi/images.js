...
export default {
	...
	recommendation: {
		...
		macosDockerTip:
			"Apple Container provides stronger VM-level isolation on macOS 26+. Install it for automatic use (clawmaster prefers it over Docker). Run: brew install container",
		linuxDockerTip:
