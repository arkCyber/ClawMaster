...
export default {
	...
	featuredOpenClaw: "ClawdHub से समुदाय कौशल",
	featuredAnthropic: "आधिकारिक Anthropic एजेंट कौशल",
	featuredVercelAgent: "Vercel एजेंट कौशल संग्रह",
	featuredVercelSkills: "Vercel कौशल टूलकिट",
	confirmDisableAll: "अभी सभी तृतीय-पक्ष कौशल अक्षम करें?",
	confirmInstall: "{{name}} के लिए निर्भरता स्थापित करें?\n\n{{preview}}\n\nकेवल तभी जारी रखें यदि आप इस कौशल और इसके स्रोत पर भरोसा करते हैं।",
	confirmTrust: "{{source}} से \"{{name}}\" कौशल पर भरोसा करें?",
	confirmDelete: "\"{{name}}\" कौशल हटाएं? यह SKILL.md फ़ाइल हटा देता है।",
};
